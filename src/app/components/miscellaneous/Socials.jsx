...
const Socials = ({ lightMode, setLightMode }) => {
  return (
    <VStack
      ...
      gap={"1.5rem"}
    > 
    <Link href={'https://www.linkedin.com/in/kutubofficial'} target="_blank">
      <Box
      ...
      <Link href={'https://www.github.com/kutubofficial'} target="_blank">
        <Box
          bgColor={lightMode ? "#fff" : "#333"}
          border={lightMode ? "0.01rem solid #d1d1d1" : "0.01rem solid #555"}
          px={3}
      ...
      <Link href={'mailto:kutubofficial599@gmail.com'} target="_blank">
        <Box
          bgColor={lightMode ? "#fff" : "#333"}
          border={lightMode ? "0.01rem solid #d1d1d1" : "0.01rem solid #555"}
          px={3}
